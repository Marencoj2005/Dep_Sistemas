...
class Metodo():
    ...
    def llenarInventario(self):
        ...
        for i in range(cantidad):
            ...
            tipo = input("Ingrese el tipo de artículo (t para tablet): ")
            if tipo.lower() == "t":
        ...
        if len(pila_pc) == 0:
            ...
            return pila_pc, pila_tablets

    def buscar(self, pila_pc, pila_tablets):
        print("¿Que desea buscar? Computador[c] o Tablet[t] o no desea buscar [e]?")
        option = input()
        if option.lower() == "c":
            ...
            if option.lower() == "t":
                print("Ingrese el serial de la tablet")
                serial_search = input()
                pila_tablets_auxiliar = []
                for i in pila_tablets:
                    if i.get_serial() != serial_search:
                        pila_tablets_auxiliar.append(i)
                    else:
                        print("ENCONTADOR")
                        print("Serial: ", i.get_serial())
                        print("Marca: ", i.get_marca())
                        print("Tamaño: ", i.get_tamano())
                        print("Precio: ", i.get_precio())
                        print("Nombre Usuario: ", i.get_nombre_usuario())
                        print("Disponible: ", i.get_disponible())
                        print("Cantidad: ", i.get_cantidad())
